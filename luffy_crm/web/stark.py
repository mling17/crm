...
from web.views.job import JobListHandler
from web.views.remark_jobs import RemarkJobHandler
...
site.register(models.JobRecord, JobListHandler)
site.register(models.RemarkJobs, RemarkJobHandler)
