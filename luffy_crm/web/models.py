...
class JobRecord(models.Model):
    ...
    作业表
    """
    student = models.ForeignKey(to='Student', verbose_name='学员', on_delete=models.CASCADE)
    job = models.TextField(verbose_name='作业内容')
    date = models.DateField(verbose_name='交作业时间', auto_now_add=True)


class RemarkJobs(models.Model):
    """
    批改作业表
    """
    remark_text = models.TextField(verbose_name='批语内容')
    job_record = models.ForeignKey(to='JobRecord', verbose_name='作业内容', on_delete=models.CASCADE)
    date = models.DateField(verbose_name='批改时间', auto_now_add=True)
